...
<div style="text-align: center; font-size: 34px; margin-top: 20px;">Zadanie <?php echo $test_number; ?></div>
    ...
    <a target="bidding" href="right_bidding_pop.php?biddingtest=$test_id" 
    onclick="window.open('right_bidding_pop.php?biddingtest=<?php echo $test_id; ?>', 'Right bidding').focus(); return false">
