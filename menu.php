...
<header>
    <nav class="navbar navbar-dark bg-absurd-col-light navbar-expand-md">
        <a class="navbar-brand" href="menu.php">
            <img src="img/logo.png" widht="30" height="30" 
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="logout.php">   
                        ...
                        height: 30px; border: 1px solid black; border-radius: 75%;' 
...
<section class="menu_view_container">
    ...
    <div class="container">
        <div class="row" style="margin-top: 50px;">
            ...
            <div class="col-sm-4">
                <figure>
                    <a href="account_settings.php"><img src="img/ustawienia.png" 
                        class="img-fluid menu_view_container-box" alt="licytacja"></a>
