    ...
    <form class="login-form text-center" action="login.php" method="post">
        ...
        <div class="form-group">
            <input type="text" class="form-control rounded-pill form-control-lg"
             name="login" placeholder="Login" autocomplete="off" required="required">
        </div>
        <div class="form-group">
            <input type="password" class="form-control rounded-pill form-control-lg" 
            name="password" placeholder="Hasło" autocomplete="off" required="required">
        </div>
        ...
        <button type="submit" class="btn mt-5 btn-custom btn-block 
            rounded-pill btn-lg bg-absurd-col-dark">Zaloguj</button>
        <?php
