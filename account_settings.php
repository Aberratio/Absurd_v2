    ...
    <form action="" method="post" class="settings_form" enctype="multipart/form-data">
          <table>
            ...
            <tr>
              ...
              <td><a class="btn btn-default" style="text-decoration: none;font-size: 15px; color: #5dbaf89c;" href="change_password.php"><i class="fa fa-key fa-fw" aria-hidden="true"></i>Zmiana hasła</a></td></tr>
